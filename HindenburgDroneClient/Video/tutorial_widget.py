...
class TutorialWidget(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.panel.setFixedSize(1100, 800)
        ...
        steps = [
            ...
            ("4. START THE SERVER", "In the PuTTY terminal run:\n"
             "  'python3 HindenburgDroneServer/HindenburgDroneServer/main_server.py'\n\n"
        ...
        for i, (step_title, step_text) in enumerate(steps):
            ...
            if i < len(steps) - 3:
                ...
                img_label.setFixedHeight(500)
            
                img_path = os.path.join("Video", "assets", f"{i+1}.jpg")
            
                if os.path.exists(img_path):
                    pixmap = QPixmap(img_path)
                    scaled_pixmap = pixmap.scaled(1000, 500, Qt.KeepAspectRatio, Qt.SmoothTransformation)
